...
static void initStatic__Cardinal()
{
    ...
    if (spl.ok())
    {
        ...
        spl.removeModule("HostMIDI");
        spl.removeModule("HostMIDICC");
        spl.removeModule("HostMIDIGate");
        spl.removeModule("HostMIDIMap");
        p->addModel(modelHostParameters);
        p->addModel(modelHostParametersMap);
        p->addModel(modelHostTime);
        spl.removeModule("TextEditor");
        /* TODO
       #ifdef HAVE_FFTW3F
...
static void initStatic__ImpromptuModular()
{
    ...
    if (spl.ok())
    {
        ...
        spl.removeModule("Clocked-Expander");
        spl.removeModule("Clocked-Clkd");
        ...
        spl.removeModule("Phrase-Seq-16");
        p->addModel(modelPhraseSeq32);
        spl.removeModule("Phrase-Seq-Expander");
